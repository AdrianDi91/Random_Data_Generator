...
import sys, time, random, threading, logging
...
class DataGenWindow(QMainWindow, UI_MainWindow):
        def __init__(self):
                ...
                # self.start_button.clicked.connect(Functions.start_generation)
                # self.stop_button.clicked.connect(Functions.stop_generation)
